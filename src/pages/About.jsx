...
export const About = () => {
  ...
  return (
    <main className="w-full relative ">
      ...
      <section className="flex flex-wrap justify-center items-start px-4 lg:px-20">
        <div className="flex justify-center items-center w-full mb-5 lg:w-1/2">
          <img src={Borboleta} alt="" className="w-full lg:w-[50%]" />
        </div>
        <div className="flex flex-col justify-center items-start w-full lg:w-1/2 ">
          <p className="text-gray_700 text-xl mb-5 lg:text-2xl lg:leading-10 ">
